...
public class MainActivity extends Activity  implements NfcAdapter.ReaderCallback{
    ...
    private String writeMifareTag(MifareUltralight mifare, String tagText) {
        // TODO: connect mifare
        // We always write 1 page at a time (4 bytes each)
        // HINT: ASCII encoding uses one byte per character
        for (int i = 0; i < 4; i++) {
            int stringIndex = i * 4;
            String pageString = tagText.substring(stringIndex, stringIndex + 4);
            // TODO: write page
        }
        // TODO: Exception handling (close mifare!)
        return tagText;
    }
    ...
    private String readMifareTag(MifareUltralight mifare) {
        // TODO: connect mifare
        // We always read 4 pages at a time
        // TODO: Read pages
        // TODO: Exception handling (close mifare!)
        return null;
    }
